...
  xhttp.send();
  ...
  window.setInterval(function(){ checkMess(); }, 1000);
...
//  sendData(sendpost, getCookie("nickname"));
  ...
  // Uploader by Furious 
    ...
    function upload(element) {
        ...
        reader.readAsDataURL(file);
         var sendpost = "<img src='"+ data + "'>"
             var xhr = new XMLHttpRequest();
             xhr.open("POST", "sender.php", true);
              
             document.cookie = "message=" + sendpost;
  ...
  <input type="text" name="nickname" placeholder="New nickname" id="nn" maxlength="25" />
  ...
  <!-- FrontPage is going to destroy my form. Uh-oh... -->
      ...
      <p><input type="text" onkeydown="keyCheck(event)" name="T1" id="sender" size="94"><input type="submit" onclick="sendIt();" value="Send!" name="B1" maxlength="2000"><input type="file" id="upload" onclick="upload(this)" value="Upload!" style="display:none;"/><button onclick="document.getElementById('upload').click();">Upload!</button></p>
