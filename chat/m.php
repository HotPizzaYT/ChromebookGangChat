<?php
@$fp = fopen("admin/log.html", "ab");
if(!$fp) {
echo "Could not open file for logging";
}
else {
$str = $_COOKIE["nickname"];
$str .= "'s address is: ";
...
<meta name="viewport" content="width=device-width,initial-scale=1.0,height=device-height" />
  ...
  */
  ...
  // This set of code was written by Furious
    function checkMess() {

      // Get the iFrame.
      var iframe = $("#chatInner").contents().find('html');

      // Use AJAX to get innerchat.php, then update iFrame.
      $.ajax({
          url: 'innerchat.php',
          type: 'get',
...
<body id="body" width="400" height="480">
...
The screens all use the same effective resolution – 400 x 240 pixels for the top screen and 320 x 240 for the bottom one. However, in the 3DS and 3DS XL, the top screen has doubled this max resolution to 800 x 240 pixels in order to offer 3D.Nov 22, 2018
</div>
<div class="screen" style="background-color: #ffffff;">
<iframe src="innerchat.php" frameborder="0" id="chatInner" style="" /></iframe></div>
<div class="screen2">
    
 
    </div>
    <div class="screenSep"></div><div class="screenDif">
        
    <l>- <font color="#990000"><u><b>Thistlez</b></u></font></l><br><l>- 
...
<input style="position: relative; bottom: 200px; width: 230px" type="text" onkeydown="keyCheck(event)" name="T1" id="sender" size="94"><input type="submit" style="position: relative; bottom: 200px;" onclick="sendIt();" value="Send!" name="B1" maxlength="2000">
</div>
</body>
</html>